    ...
    public function show(Employee $employee)
    {
        ...
        $employeeData = [
            ...
            'current_shift' => $currentSchedule && $currentSchedule->shift ? [
                ...
                'time_in' => $currentSchedule->shift->time_in->format('g:i A'),
                'time_out' => $currentSchedule->shift->time_out->format('g:i A'),
                'date_start' => $currentSchedule->date_start->format('M d, Y'),
                'date_end' => $currentSchedule->date_end ? $currentSchedule->date_end->format('M d, Y') : null,
            ] : null,
            'contact_number' => $employee->contact_number,
