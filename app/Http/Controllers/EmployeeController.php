    ...
    public function show(Employee $employee)
    {
        ...
        $employeeData = [
            ...
            'current_shift' => $currentSchedule && $currentSchedule->shift ? [
                ...
                'time_in' => $currentSchedule->shift->time_in ? \Carbon\Carbon::parse($currentSchedule->shift->time_in)->format('H:i') : null,
                'time_out' => $currentSchedule->shift->time_out ? \Carbon\Carbon::parse($currentSchedule->shift->time_out)->format('H:i') : null,
